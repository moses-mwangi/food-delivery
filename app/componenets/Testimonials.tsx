...
const Testimonials = () => {
  ...
  return (
    <div className="py-10 mb-32 mt-20">
      <div className="container">
        <div className=" flex flex-col gap-2 text-center mb-10 max-w-[600px] mx-auto">
          <p
            data-aos="fade-up"
            className="text-sm text-primary text-orange-600"
          >
          ...
          <Slider {...settings}>
            {TestimonialData.map((data) => (
              <div key={data.id} className="my-6">
                <div
                  key={data.id}
                  className="flex flex-col gap-4 shadow-lg py-6 px-8 mx-4 rounded-xl bg-primary/5 relative"
                >
                  <div className="mb-4">
                    <Image
                      src={data.img}
